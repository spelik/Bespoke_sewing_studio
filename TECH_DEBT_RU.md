...
- Для production auth остаются password recovery/email confirmation, Admin 2FA, rate limiting login, session-retention policy и ротация JWT signing key через внешний secret store.
