...
- Для Email Outbox остаются future-задачи: external alerting/notifications (email/Slack/webhook) по exhausted jobs, external archival/anonymization policy для long-term email metadata, multi-instance locking hardening и PostgreSQL integration tests. (Manual retry — Task 76; admin monitoring — Task 77; retention cleanup succeeded/skipped bodies — Task 78.)
