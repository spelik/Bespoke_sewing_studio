...
- Для Email Outbox остаются future-задачи: admin dashboard, alerting по exhausted jobs, retention/очистка завершённых outbox bodies, multi-instance locking hardening и PostgreSQL integration tests. (Manual retry реализован — см. Task 76.)
